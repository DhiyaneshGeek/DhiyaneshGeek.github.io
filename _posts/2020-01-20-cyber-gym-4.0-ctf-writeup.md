...
**Step 19:** Bypass the WAF using by change few things on the file formats using the below command.

<p align="center">
  <strong>cat sample.xml | iconv -f UTF-8 -t UTF-16BE > payload.xml</strong>
</p>
