...
**Setp 6:**  Now using the following command we will be able to do a directory listing on the server. 
...
**Setp 7:** From the above image it is observed that there is a directory called `flag_is_here`.

**Setp 8:** Navigate to the following directory using the following payload.
...
**Setp 9:** Looking into the **flag.txt** file , we found there is a directory called `\hogwart-access-log\`.

<p align="center">
  <img src="/images/cybergym4/web25.png">
</p>

**Setp 10:** Lets look into the `\hogwart-access-log\`  see what is inside it.
...
**Setp 10:** Open the **final.log** file as shown below.

<p align="center">
  <img src="/images/cybergym4/web27.png">
</p>

**Setp 11:** We can see that there is **String.fromCharCode**. 

<p align="center">
  <img src="/images/cybergym4/web28.png">
</p>

**Setp 12:** Decrypt the encoded **String.fromCharCode** using Burpsuite decoder, you can use smart decode.

<p align="center">
  <img src="/images/cybergym4/web29.png">
</p>

**Setp 13:** Copy the Decrypted **String.fromCharCode** , we need to covert this to readble **plain text**.
...
**Setp 14:** From  the above image , it can be seen that we have got a another domain called <http://hogwart-library.cybergym.lucideus.in>
