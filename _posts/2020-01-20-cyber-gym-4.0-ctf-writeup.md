...
**Step 8 :** Now Let's move to the third page , it had some **Base64** string encoded.

<p align="center">
  <img src="/images/cybergym4/osint13.png">
</p>

**Step 9 :** Decrypted the **Base64** algorithm using this website <https://www.base64decode.org/>.

<p align="center">
  <img src="/images/cybergym4/osint14.png">
</p>

**Step 10 :** We got a another **anonymousfile.io** shareable link <https://anonymousfiles.io/bai39RHM/> , Download the file.

<p align="center">
  <img src="/images/cybergym4/osint15.png">
</p>

**Step 11 :** Now we can run **Mnemonic Encryption & Decryption**  tool and get the secret text out as shown below.

<p align="center">
  <img src="/images/cybergym4/osint16.png">
</p>

**Step 12 :** The decrypted text has a username `_harry_wizardry_telling` , found this username on one of the instagram account.

<p align="center">
  <img src="/images/cybergym4/osint17.png">
</p>

**Step 13 :** There was a sound cloud account on the **Instagram Bio** <https://soundcloud.com/harry-rom-215683629> .

<p align="center">
  <img src="/images/cybergym4/osint18.png">
</p>

**Step 14 :** Upon opening the soundcloud account it redirected to <https://soundcloud.com/harry-rom-215683629>, there was nothing inside in it.

<p align="center">
  <img src="/images/cybergym4/osint19.png">
</p>

**Step 15 :** So i tried to login into the soundcloud account using the username **harry-rom-215683629** and password is **Scotland-UK** taken from the instagram post Location which had some hint **"location is the key"** as shown below.
...
**Step 16 :** We were able to successfully log-in , after that found that there is video which was kept in **private**.

<p align="center">
  <img src="/images/cybergym4/osint22.png">
</p>

**Step 17 :** Looking closely on the video title , there was a another hint **Hearmewitheyes** .

<p align="center">
  <img src="/images/cybergym4/osint23.png">
</p>

**Step 18 :** So i downloaded the song file and opened with **Sonic Visualizer** .
