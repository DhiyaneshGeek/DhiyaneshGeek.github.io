...
**Step 4 :** Through googling found a script to make it in a readable format. [its-sarin/BrailleCodec: A small python script to encode plain text to Braille or decode Braille to plain text](https://github.com/its-sarin/BrailleCodec).
